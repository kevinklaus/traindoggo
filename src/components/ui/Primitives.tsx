...
export const TOKENS = {
  ...
  layouts: {
    card: "bg-white rounded-2xl sm:rounded-3xl hover:shadow-md transition-all overflow-hidden",
...
export function LogoMark({ size = 'default' }: { size?: 'default' | 'large' | 'small'}) {
  ...
  return (
    <div
      className={`inline-flex items-center justify-center bg-accent shrink-0 ${wrap}`}
      aria-hidden="true"
    >
