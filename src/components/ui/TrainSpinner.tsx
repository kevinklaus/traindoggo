...
export function TrainSpinner() {
  ...
  // A11y: State für das Pausieren der Animation
  ...
  useEffect(() => {
    // Wenn pausiert ist, stoppen wir auch den Textwechsel
    if (isPaused) return;
  ...
  // A11y: Toggle-Funktion für Maus und Tastatur
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      {/* Container: aspect-[5/2] macht ihn komplett responsive ohne Ränder! */}
      <div 
        role="button"
        tabIndex={0}
        ...
        className={`relative overflow-hidden rounded-2xl bg-gradient-to-b from-blue-50 to-white w-full max-w-[400px] aspect-[5/2] shrink-0 cursor-pointer focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 transition-shadow ${isPaused ? 'is-paused' : ''}`}
      >
        <style dangerouslySetInnerHTML={{__html: `
          ...
          /* A11Y: Pausiert die Animation exakt im aktuellen Frame */
          .is-paused .animate-drive,
          .is-paused .animate-wag {
            animation-play-state: paused !important;
          }

          /* A11Y: Respektiert die OS-Einstellungen */
        ...
        <svg viewBox="0 0 400 160" className="w-full h-full block">
          
          {/* 1. HINTERGRUND BERGE */}
          <path d="M 0 110 Q 60 50 140 80 T 280 60 T 400 100 L 400 160 L 0 160 Z" fill="#e2f0e9" opacity="0.8" />
          <path d="M -20 130 Q 80 70 170 110 T 320 80 T 420 130 L 420 160 L -20 160 Z" fill="#b7c0ba" opacity="0.5" />
          ...
          <line x1="0" y1="110" x2="400" y2="110" stroke="#64748b" strokeWidth="1.5" />

          {/* 3. DER ICE 3 */}
          <g className="animate-drive">
            
            <g className="animate-wag">
              <path d="M 28 100 Q 15 85 20 75" fill="none" stroke="#b96524" strokeWidth="4.5" strokeLinecap="round" />
              <path d="M 28 100 Q 17 85 21 76" fill="none" stroke="#f4af5a" strokeWidth="2" strokeLinecap="round" />
            </g>
          ...
          {/* 4. VORDERGRUND BERGE */}
          <path d="M 0 160 L 0 40 Q 30 60, 45 110 T 120 160 Z" fill="#90a89d" />
          <path d="M 400 160 L 400 40 Q 370 60, 355 110 T 280 160 Z" fill="#90a89d" />
