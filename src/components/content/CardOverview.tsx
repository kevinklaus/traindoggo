...
export default function CardOverview({ cardFields, data, onAction, actionLabel }: Props) {
      ...
      {data.map(card => (
        <div 
          ...
          className={`flex flex-col bg-white ${
            card.highlight 
              ? 'bg-gradient-to-b from-highlight/30 to-highlight/30' 
              : 'bg-gradient-to-b from-highlight/10 to-highlight/10'
          } rounded-2xl transition-all overflow-hidden relative scroll-mt-24`}        >
          {card.image && (
