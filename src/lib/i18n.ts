  ...
  contentPages: {
    ...
    destinations: {
      ...
      cards: [
        ...
        { destination: "🇩🇪 Thüringer Wald", description: "Historische Altstädte (z.B. Erfurt & Weimar) und geniale Ausflugsziele wie die Wartburg. Der Thüringer Wald bietet unendlich viel Natur zum Wandern.", travel: "Schnell aus ganz Deutschland mit dem ICE angebunden (über den ICE-Knotenpunkt Erfurt)." },
