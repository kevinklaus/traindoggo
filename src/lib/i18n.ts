...
const deTranslations = {
  ...
  composition: {
    ...
    ui: {
      ...
      vagonwebBestSeats: "Tipp für Hunde: Plätze mit Rückenlehne an Rückenlehne oder Plätze, deren Rückenlehne direkt an eine Gepäckablage, einen Raumtrenner/Schiebetür oder ans Wagenende grenzen, sind meistens die besten Optionen.",
      realComposition: "Echte Wagenreihung (vagonWEB)",
      fullscreen: "Vollbild",
      interactiveMap: "Sitzplan",
...
const enTranslations = {
  ...
  composition: {
    ...
    ui: {
      ...
      vagonwebBestSeats: "Tip for dogs: back-to-back seats, or seats where the backrest is directly against a luggage rack, a partition/sliding door, or the end of the carriage are often best for a relaxed journey.",
      realComposition: "Real composition (vagonWEB)",
      fullscreen: "Fullscreen",
      interactiveMap: "Seat Map",
